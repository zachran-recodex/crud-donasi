                ...
                <div class="px-6 py-4">
                    <form action="{{ route('donations.update', $donation) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            @if($donation->image)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $donation->image) }}" alt="Gambar Donasi" class="w-32 rounded-lg">
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="status"
                                    ...
                                    class="shadow appearance-none border border-gray-600 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                    required>
                                <option value="1" {{ $donation->status ? 'selected' : '' }}>Aktif</option>
                                <option value="0" {{ !$donation->status ? 'selected' : '' }}>Nonaktif</option>
                            </select>
                        </div>
